...
class GenomicDataset(Dataset):
    ...
    def __len__(self):
        return len(self.samples.windowsdf)

    def __getitem__(self, idx):
        windowsdf = self.samples.windowsdf
        windows = windowsdf.iloc[idx]
        sample_sequence = samples.seq[windows["start"]:windows["end"]]
        # Process track values
        track_values = self.samples.cov_fwd[windows["start"]:windows["end"]]
